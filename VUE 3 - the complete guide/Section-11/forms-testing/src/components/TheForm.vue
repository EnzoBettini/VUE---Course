<template>
  <form @submit.prevent="submitForm">
    <div class="form-control" >
      ...
      <input id="user-name" name="user-name" type="text" v-model.trim="userName" @blur="validateInput" :class="{invalid: usernameValidity === false}"/>
      <p v-if="usernameValidity === false">Please add a valid username</p>
    </div>
    <div class="form-control">
    ...
    <div class="form-control">
      ...
      <label for="terms">Do you agree with the terms of use?</label>
    </div>
    <div>
